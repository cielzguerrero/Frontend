    ...
    <div class="owl-carousel owl-theme">
      ...
      do { ?>
        <div class="item"><img src="../admin/images/news/<?php echo $rows['news_img']; ?>">
          ...
          <a href="NewsContent.php?ID=<?php echo $rows['news_id']; ?>">continue reading...</a></p>
        </div>
      <?php $ranker++;
      ...
      <div class="rank-wrapper">
        ...
        <div class="rank-3">
          <div class="top2">
            ...
            ?>
            <img src="../admin/images/profile/<?php echo $row['img_name']; ?>">
            <p><?php echo $row['profileuser']; ?></p>
            <h5><?php echo $totalpoints; ?></h5>
          </div>
          <div class="top1">
            <?php
            $thisyear = date('Y');
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <ul class="social-icons">
              ...
              <li><a class="linkedin" href="https://www.linkedin.com/in/aldrin-ramores-556798202/"><i class="fa fa-linkedin"></i></a></li>
            </ul>
          </div>
        </div>
      </div>
