...
<nav class="bg-white border-gray-200 px-2 shadow-xl dark:shadow-xl sm:px-4 py-4  dark:bg-slate-800">
    ...
    <div class="content pt-10">
        <div class="content-wrapper  ">
            <!-- NEWS IMAGE -->
        <img src="admin/images/news/News-405.jpg">
            <!-- NEWS CONTENT -->
        <h1 class ="py-10 text-center text-4xl font-bold">NEWS TITLE</h1>
        <p class = "">Sample Content</p>
        <p class = "">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis neque reprehenderit vero qui aliquam suscipit quisquam consectetur esse tempora, sapiente deleniti blanditiis quaerat placeat libero veniam maxime cupiditate beatae asperiores.</p>
        </div>
